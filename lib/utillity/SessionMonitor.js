 ...
 * logged out.
 */
Ext.define('Owl.utility.SessionMonitor', {
    singleton: true,
    ...
    window: Ext.create('Ext.window.Window', {
        ...
        buttons: [{
            ...
            handler: function () {
                Ext.TaskManager.stop(BackOffice.util.SessionMonitor.countDownTask);
                BackOffice.util.SessionMonitor.window.hide();
                BackOffice.util.SessionMonitor.start();
