...
BL_Users.prototype.findBy = function(req, query, options, callback){
    logger.info("BSN [%s] business/%s.findBy request", req.sessionID, collection);
    var children = [];
    var projection = {};
    logger.info("BSN [%s] query: %j, projection %j, options: %j", req.sessionID, query, projection, options);
