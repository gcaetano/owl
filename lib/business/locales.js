...
var BL_Locales =  function(){};
const collection = 'locales';


BL_Locales.prototype.read = function(callback){
    var query = {};
...
BL_Locales.prototype.readOne = function(id, callback){
...
BL_Locales.prototype.create = function(object, issuer, callback){
...
BL_Locales.prototype.delete = function(id, callback){
...
BL_Locales.prototype.update = function(id, object, issuer, callback){
...
exports.BL_Locales = new BL_Locales();